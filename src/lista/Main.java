...
public class Main {
	...
	public static void main(String[] args) {
		...
		/*
		 * Livro testeLivro = new Livro(); testeLivro.setTitulo("Livro teste");
		 * testeLivro.setAutor("daniel"); testeLivro.setAnoPublicacao(2010);
	...
	private static void adicionarLivro() {
		...
		String autor = JOptionPane.showInputDialog(null, 
				"Digite o autor do livro", "Livraria Deus é bom", 1);
